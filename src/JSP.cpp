...
int main(int argc, char** argv)
{
    ...
    states.name.push_back("HeadYaw");
    states.position.push_back(0.0);
    states.name.push_back("HeadPitch");
    states.position.push_back(0.0);
    ...
    states.name.push_back("LHipYawPitch");
    states.position.push_back(0.0);
    states.name.push_back("LHipRoll");
    states.position.push_back(0.2);
    states.name.push_back("LHipPitch");
    states.position.push_back(-0.5);
    states.name.push_back("LKneePitch");
    states.position.push_back(1.0);
    states.name.push_back("LAnklePitch");
    states.position.push_back(0.2);
    states.name.push_back("LAnkleRoll");
    states.position.push_back(0.0);

    states.name.push_back("RHipYawPitch");
    states.position.push_back(0.0);
    states.name.push_back("RHipRoll");
    states.position.push_back(-0.2);
    states.name.push_back("RHipPitch");
    states.position.push_back(-0.5);
    states.name.push_back("RKneePitch");
    states.position.push_back(1.0);
    states.name.push_back("RAnklePitch");
    states.position.push_back(0.0);
    states.name.push_back("RAnkleRoll");
    states.position.push_back(0.2);
